...
class RekomendasiPage extends StatelessWidget {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Stack(
                children: [
                  Header(userName: 'Zulfa Ulinnuha'), // Reuse the Header component
                  Positioned(
                    left: 0,
                    top: 16,
              ...
              SizedBox(height: height * 0.02),
              _buildRecommendationList(width, height, context), // Kirim context di sini
            ],
          ),
        ),
      ),
  ...
  Widget _buildRecommendationList(double width, double height, BuildContext context) {
